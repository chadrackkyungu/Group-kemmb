...
class Services extends Component {
    ...
    state = {
        ...
        services1: [
            { title: "Transportation", icon: FaBusAlt, description: "Group Maka Investment services will focus on creating a transformative and sustainable bus and coach transportation in the Democratic republic of Congo" },
        ...
        services2: [
            { title: "Securities", icon: SiSpringsecurity, description: "Private investment is essential if agriculture is to fulfil its vital function of contributing to economic development, poverty reduction and food security" },
            { title: "Logistics", icon: TbTruckLoading, description: " Investments in agricultural logistics create global businesses and enhance trading between nations. Of course, with good management practices." },
