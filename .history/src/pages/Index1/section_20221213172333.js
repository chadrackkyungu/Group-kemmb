                            ...
                            <Container>
                                <Row className="row justify-content-center">
                                    <Col lg="10" className="text-center">
                                        ...
                                        <p className="pt-4 home-sub-title text-white mx-auto">Group Maka Services is open platform company that provides different type of services in order to bring their stone in the development of a better tomorrow for everyone</p>
