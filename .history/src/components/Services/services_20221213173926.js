...
class Services extends Component {
    ...
    state = {
        ...
        services2: [
            ...
            { title: "Casting", icon: SiWikimediacommons, description: " Investments in agricultural logistics create global businesses and enhance trading between nations. Of course, with good management practices." },
