...
class Services extends Component {
    ...
    state = {
        services: [
            ...
            { title: "Construction (Mining)", icon: GiTowTruck, description: "Group Maka Investment services is entitled to facilitate the extraction of metals and minerals through investment Project in the Democartic republic of Congo." },
        ],
        services1: [
