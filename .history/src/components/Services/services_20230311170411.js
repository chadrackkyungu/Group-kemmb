...
class Services extends Component {
    ...
    state = {
        services: [
            ...
            { title: "Chemical Manifacture", icon: Agriculture, description: "Manufactures of pesticides, cleaning detergent and spirit supplying to over 1500 farmers seek  investment or a community ( investors agriculture products and services)." },
